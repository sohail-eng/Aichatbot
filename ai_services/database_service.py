...
class DatabaseService:
    ...
    def create_connection(self, connection_config: Dict) -> str:
        ...
        try:
            ...
            connection_id = f"{connection_config['server']}_{connection_config['database']}"
    ...
    def _build_mssql_connection_string(self, config: Dict) -> str:
        ...
        return (f"DRIVER={driver};SERVER={server},{port};"
    ...
    def execute_query(self, connection_id: str, query: str, session_id: str = None) -> Dict:
        ...
        try:
            ...
            if session_id:
                self._log_query_execution(
                    session_id, connection_id, query, 
                    len(results), execution_time, True
                )
            ...
            if session_id:
                self._log_query_execution(
                    session_id, connection_id, query, 
                    0, execution_time, False, error_msg
                )
    ...
    def get_table_sample(self, connection_id: str, table_name: str, limit: int = 5) -> List[Dict]:
    ...
    def _log_query_execution(self, session_id: str, connection_id: str, 
                           query: str, result_count: int, execution_time: float, 
